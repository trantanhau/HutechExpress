...
function ws_louvers(f, q, g) {
  var h = jQuery,
    ...
    o =
      ...
      !/WOW Slider/g.test(navigator.userAgent);
  var w = [];
  n.css({
    position: "absolute",
    top: 0,
  ...
  for (var l = 0; l < a; l++) {
    ...
    E[l] = {
      ...
      rightEdge: p
        ? h("<div>").addClass("ws_right_edge").css(r).appendTo(x)
        : 0,
      topEdge: p ? h("<div>").addClass("ws_top_edge").css(r).appendTo(x) : 0,
      bottomEdge: p
        ? h("<div>").addClass("ws_bottom_edge").css(r).appendTo(x)
        : 0,
    };
  }
  function A(L) {
    ...
    for (var i in K) {
      if (typeof E[i] !== "function") {
        K[i].topEdge.css({
          ...
          background: j[i],
          transform:
            "rotateX(90deg) translate3d(0,-" + H / 2 + "px," + H / 2 + "px)",
        });
        K[i].bottomEdge.css({
          width: I,
          height: H,
        ...
        K[i].leftEdge.css({
          ...
          background: j[i],
          transform:
            "rotateY(90deg) translate3d(" + H / 2 + "px,0,-" + H / 2 + "px)",
        });
        K[i].rightEdge.css({
          width: H,
          height: J,
          ...
          wowAnimate(
            function (M) {
              ...
              if (M <= 0.5) {
                ...
                S = h.easing
                  .easeOutBack(1, (M - 0.5) * 2, 0, 1, 1, 1)
                  .toFixed(3);
                Q = h.easing
                  .easeOutBackQ(1, (M - 0.5) * 2, 0, 1, 1, 1)
                  .toFixed(3);
                R = h.easing
                  .easeOutBackQ2(1, (M - 0.5) * 2, 0, 1, 1, 1)
                  .toFixed(3);
                  ...
                  if (N === "scale") {
                    ...
                    if (N === "translate3d") {
                      P +=
                        N +
                        "(" +
                        (T[0] + (O[0] - T[0]) * S).toFixed(3) +
                        "px," +
                        (T[1] + (O[1] - T[1]) * S).toFixed(3) +
                        "px," +
                        (T[2] + (O[2] - T[2]) * S).toFixed(3) +
                        "px) ";
                    } else {
                      L[N] = O;
                    }
              ...
              K[J].wrapper.css({
                transform:
                  "translate3d(" +
                  (L.left ? L.left : 0).toFixed(3) +
                  "px," +
                  (L.top ? L.top : 0).toFixed(3) +
                  "px,0)",
              });
              delete L.left;
              delete L.top;
    ...
    if (p) {
      ...
      for (var L in E) {
        ...
        E[L].part
          ...
          .animate({ left: 0, opacity: 1 }, W, function () {
            H++;
            if (H == a) {
              s.stop(1, 1);
              d = false;
